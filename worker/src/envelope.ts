 ...
 * e teia no caminho; aqui a Response já vem pronta do handler. O import vem de `../../dist/`
 * porque o Worker e o servidor stdio sao pacotes npm separados neste repo, e e
 * assim que worker/src ja alcanca a raiz (ver config.ts, index.ts, server.ts).
 */

import { classeDoErroRpc, classifyError, errorText, type ErrorClass } from "../../dist/call-shape.js";
