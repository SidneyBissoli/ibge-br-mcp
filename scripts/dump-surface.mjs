 ...
 * (worker/src/server.ts), então stdio e worker partilham a superfície POR
 * CONSTRUÇÃO e as superfícies que podem divergir são só duas: o fonte local e
 ...
 *   node scripts/dump-surface.mjs --url https://ibge.sidneybissoli.com/mcp > baselines/surface-http-prod-<versao>.json
 *
